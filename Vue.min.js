 ...
 * @returns 动态子节点
 */
const forDynamicGeneration = ( { context, node: { children: templateChildren }, attrElement, attrElement2 } ) =>
{
    const forModel = {};
...
class Vue
{
    ...
    constructor ( options )
    {
        ...
        const context = new Proxy( this, {
            ...
            {
                return ( Reflect.get( target, key) ?? Reflect.get( target._data, key) ?? Reflect.get( target._methods, key) );
            }, set ( target, key, value, receiver )
            {
